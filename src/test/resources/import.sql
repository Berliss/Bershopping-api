...
insert into customers (email, first_name,last_name) values ( 'perlarodriguez@hotmail.com','perla','perla')
...
insert into addresses (description, customer_id) values ('CHINA, OH 67492-1501 6270 NW 14TH ST EPS # NG-1748', 3)
insert into addresses (description, customer_id) values ('MEXICO, BO 21492-1501 6270 NW 14TH ST EPS # NG-1748', 3)
...
insert into payment_methods (balance, number_reference, payment_type, customer_id) values (100000, 'bjkb000000000006', 'paypal', 3)

-- basket
insert into baskets (create_at,address_id,payment_method_id,customer_id) values (now(),1,3,2 )
insert into baskets (create_at,address_id,payment_method_id,customer_id) values (now(),6,7,3 )